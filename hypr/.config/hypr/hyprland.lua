...
local menu = "rofi -show combi -modi combi"
local clipboardManager = "copyq show"
local wallpaperChanger = "waypaper"
...
hl.config({
	general = {
		...
		col = {
			active_border = { colors = { Mauve, Subtext0 }, angle = 90 },
...
hl.config({
	group = {
		col = { border_active = Mauve, border_inactive = Subtext0 },
		groupbar = {
			enabled = true,
			gradients = true,
			font_size = 18,
			...
			col = {
				active = MauveAlpha,
				inactive = Base,
				locked_active = MauveAlpha,
				locked_inactive = Base,
			},
			gaps_in = 0,
			gaps_out = 0,
			text_color = Text,
