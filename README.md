...
still packaging `npm` separately. The Arch, FreeBSD and Debian columns are verified
against a real package manager; macOS, Fedora and Gentoo entries are marked
`unverified` in the manifest. The installer
